...
func (m *MockDatabaseConnection) GetAllSubscriptions(channel_id, discord_user_id string) ([]database_structs.Subscriber, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllSubscriptions", channel_id, discord_user_id)
	ret0, _ := ret[0].([]database_structs.Subscriber)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDatabaseConnectionMockRecorder) GetAllSubscriptions(channel_id, discord_user_id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllSubscriptions", reflect.TypeOf((*MockDatabaseConnection)(nil).GetAllSubscriptions), channel_id, discord_user_id)
}
